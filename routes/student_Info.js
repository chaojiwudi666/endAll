                   ...
                   if(err){
                    ...
                    res.json(newrequest);
                       ...
                       if(docs2.length>0){
                        ...
                        role_info_model.student_id=student_id_prefix+arg.class+code;
                       }else{
                        role_info_model.student_id=student_id_prefix+arg.class+"01";
                       }
                       data.connect(function(db){
